...
function SinglePageBoard({
  ...
  return (
    <SinglePageBoardBox className='px-md-5 px-sm-2 h-100 text-center' data-testid={dataTestId || 'single-page-board'}>
      ...
      <OuterRow xs={1} md={1} lg={1} xl={1}>
        <Col className='h-100'>
          ...
          <InnerBottomRow className='my-auto'>
            <InnerCol className='my-auto mx-auto h-100 py-3' data-testid='single-page-board-content-body'>
              {contentBody}
            </InnerCol>
          </InnerBottomRow>
        </Col>
