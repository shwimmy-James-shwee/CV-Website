...
export const bc3ActionGroup = new insights.ActionGroup(
  `${envBase.PROJECT_NAME_ABBREVIATION}-bc3`,
  {
...
export const bc20ActionGroup = new insights.ActionGroup(
  `${envBase.PROJECT_NAME_ABBREVIATION}-bc20`,
  {
    resourceGroupName: envBase.AZURE_RESOURCE_GROUP,
    location: `Global`,
