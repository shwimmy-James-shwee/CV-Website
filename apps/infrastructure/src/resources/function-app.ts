...
const functionApp = new web.WebApp(
  functionAppServiceName,
  {
    ...
    tags: {
      'hidden-link: /app-insights-resource-id': functionAppInsight.id.apply(
        (id) => id,
      ),
    },
    siteConfig: {
      ...
      appSettings: [
        ...
        },
        {
          ...
          value: dataStorageConnectionString.apply(
        ...
        },
        {
          ...
          value: functionAppInsight.connectionString.apply(
            (connectionString) => connectionString,
          ),
        },
        {
...
new keyvault.AccessPolicy(
  `${functionAppServiceName}-access-policy`,
  {
    ...
    policy: {
      objectId: functionApp.identity.apply(
...
new insights.DiagnosticSetting(
  `${functionAppServiceName}-pept-diagnostic-setting`,
  {
    ...
    resourceUri: functionAppPept.networkInterfaces.apply(
      (networkInterfaces) => {
