      ...
      try {
        if (familyName) {
          if (!givenName && familyName.includes(',')) {
            givenName = familyName.split(',')[1] as string;
            familyName = familyName.split(',')[0] as string;
          }
        } else if (name) {
          if (name.includes(',')) {
            givenName = name.split(',')[1] as string;
            familyName = name.split(',')[0] as string;
          }
        }
